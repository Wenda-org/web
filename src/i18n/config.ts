    ...
    translation: {
      ...
      dashboard: {
        ...
        activity: {
          ...
          recommendation_served: 'Served {{count}} recommendations in the last hour'
        }
      },
      destinations: {
        title: 'Destinations',
      ...
      landing: {
        ...
        hero: {
          ...
          description: 'Complete admin panel to manage destinations, users and analytics for Wenda with advanced AI tools.',
        ...
        features: {
          ...
          analytics: {
            ...
            description: 'Visualize KPIs in real-time and make data-driven decisions'
          },
          destinations: {
            title: 'Destination Management',
            description: 'Manage tourist destinations with an intuitive visual interface'
          },
          users: {
          ...
          ml: {
            ...
            description: 'Intelligent recommendation system powered by machine learning'
          },
          i18n: {
            title: 'Multilingual',
        ...
        preview: {
          ...
          description: 'Complete dashboard with real-time data visualizations, interactive charts and integrated management tools.',
        ...
        mobile: {
          ...
          description: 'Manage your Wenda mobile app directly from the admin panel',
          sync: {
            title: 'Instant Sync',
        ...
        cta: {
          ...
          description: 'Access the admin panel and start managing your tourism platform now.',
          primary: 'Access Dashboard',
          secondary: 'Sign in'
        },
        footer: {
          subtitle: 'Tourism in Angola',
          description: 'Leading tourism platform in Angola, connecting travelers to unique experiences.',
          product: 'Product',
          dashboard: 'Dashboard',
          destinations: 'Destinations',
          users: 'Users',
      ...
      map: {
        ...
        preview: {
          ...
          description: 'Map integration would display here (Mapbox GL or Leaflet)'
        },
        markers: 'Markers'
      },
      ml: {
    ...
    translation: {
      ...
      dashboard: {
        ...
        activity: {
          ...
          recommendation_served: 'Serviu {{count}} recomendações na última hora'
        }
      },
      destinations: {
        title: 'Destinos',
      ...
      landing: {
        ...
        hero: {
          ...
          description: 'Painel administrativo completo para gerenciar destinos, usuários e análises da plataforma Wenda com ferramentas avançadas de IA.',
          cta: 'Acessar Painel',
          secondary: 'Fazer Login'
        },
        features: {
          title: 'Recursos Principais',
          subtitle: 'Ferramentas poderosas para gerenciar sua plataforma de turismo',
          analytics: {
            title: 'Analytics Avançado',
            description: 'Visualize KPIs em tempo real e tome decisões baseadas em dados'
          },
          destinations: {
            title: 'Gestão de Destinos',
            description: 'Gerencie destinos turísticos com interface intuitiva e visual'
          },
          users: {
          ...
          ml: {
            ...
            description: 'Sistema de recomendações inteligente com machine learning'
          },
          i18n: {
            title: 'Multilíngue',
        ...
        preview: {
          ...
          description: 'Dashboard completo com visualizações de dados em tempo real, gráficos interativos e ferramentas de gestão integradas.',
        ...
        mobile: {
          ...
          description: 'Gerencie seu aplicativo móvel Wenda diretamente do painel administrativo.',
          sync: {
        ...
        cta: {
          ...
          description: 'Acesse o painel administrativo e comece a gerenciar sua plataforma de turismo agora mesmo.',
          primary: 'Acessar Painel',
          secondary: 'Fazer Login'
        },
        footer: {
          subtitle: 'Turismo em Angola',
          description: 'Plataforma de turismo líder em Angola, conectando viajantes a experiências únicas.',
          product: 'Produto',
          dashboard: 'Dashboard',
          destinations: 'Destinos',
          users: 'Utilizadores',
      ...
      map: {
        ...
        preview: {
          ...
          description: 'A integração do mapa seria exibida aqui (Mapbox GL ou Leaflet)'
        },
        markers: 'Marcadores'
      },
      ml: {
